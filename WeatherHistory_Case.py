...
os.chdir(R'E:\IVY 2021-22\PYTHON SESSIONS\MLRM\ASSIGNMENT\data')
path_data = os.getcwd()
...
# =============================================================================
All=weather_data.describe(include='all')# describes all numerical and  categorical data ## summuery stats 
len(All.index) ##to know number of rows of a dataframe
...
vif.round(1) ##rounding entire df to 1

New_X_train=X_train.drop(["Precip Type_rain"],axis = 1,inplace = True)
New_X_test=X_test.drop(["Precip Type_rain"],axis = 1,inplace = True)
